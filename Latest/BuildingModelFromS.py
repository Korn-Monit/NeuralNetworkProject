...
class Layer_Dense:
    ...
    #n_inputs = input feature = dataset
...
# Define the base path for your MNIST files
base_path = 'D:\\Files\\IMT-Mines-Ales\\Math Analytique\\Project\\DL project\\NNProject\\Dataset\\dts\\'
...
# Preprocess (flatten and normalize) the data
X_train = X_train.reshape((X_train.shape[0], -1)) / 255.0
y_train = y_train.reshape(-1, 1)
X_test = X_test.reshape((X_test.shape[0], -1)) / 255.0
y_test = y_test.reshape(-1, 1)

#make the label suitable for training
...
# print("X",X_sample.shape, "y",y_sample.shape)
# print(X_train)
...
for epoch in range(10001):
    ...
    X_sample = X_sample.reshape((1, -1))  # Flatten the input to (1, 784)
    # print(X_sample.shape)
    dense1.forward(X_sample.T)
    ...
    loss = loss_activation.forward(dense2.output, y_sample)
    ...
    # Backward pass
    loss_activation.backward(loss_activation.output, y_sample)
